        ...
        <header class="bg-white shadow-sm rounded-xl">
          <div class="flex items-center justify-between px-6 py-4">
            <div class="flex items-center space-x-4">
              ...
              <RouterLink :to="{ name: 'teams.members.add'}" class="rounded-lg bg-indigo-600 px-4 py-2 flex gap-2 items-center justify-center font-medium text-white hover:bg-indigo-700">
        ...
        <div class="flex-1 overflow-y-auto p-6">
          ...
          <div class="mx-auto max-w-6xl">
            <div class="mb-6 flex space-x-4">
              <button class="rounded-lg border-2 border-indigo-600 bg-white px-4 py-2 font-medium text-indigo-600 shadow-sm">All Teams</button>
              <button class="rounded-lg bg-white px-4 py-2 font-medium text-gray-600 shadow-sm hover:border-2 hover:border-indigo-600">Development</button>
              <button class="rounded-lg bg-white px-4 py-2 font-medium text-gray-600 shadow-sm hover:border-2 hover:border-indigo-600">Design</button>
              <button class="rounded-lg bg-white px-4 py-2 font-medium text-gray-600 shadow-sm hover:border-2 hover:border-indigo-600">Marketing</button>
            </div>
