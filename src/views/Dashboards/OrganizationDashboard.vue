    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 rounded-lg mt-14">
            <div class="grid grid-cols-3 gap-4 mb-4">
                <div class="h-24 bg-yellow-100 text-yellow-800 p-4 rounded-lg shadow-md transform transition-all duration-300 hover:scale-105 flex items-center justify-between">
                    <div>
