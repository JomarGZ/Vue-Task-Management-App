            ...
            <form @submit.prevent="store.handleSubmit()" class="space-y-6">
                ...
                <div class="space-y-4 pt-4 border-t">
                    ...
                    <div class="bg-yellow-50 border p-2 rounded-md">
                        ...
                        <p>If you don't have another email, you can use your existing Gmail address with a <code>+anyword</code> suffix. SprintSync will still deliver the email to your original inbox.</p>
