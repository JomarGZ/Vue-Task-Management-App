...
const uploadAvatarPreview = (event: Event) => {
...
const handleDrop = (event: DragEvent) => {
    ...
    if (files && files.length > 0) {
        ...
        if (file.type.startsWith('image/') && file.size <= 5 * 1024 * 1024) {
            handlePhotoPreview({ target: { files: [file] } } as unknown as Event);
            changeAvatar.form.avatar = file;
        } else {
            changeAvatar.errors.avatar = ['Please upload a valid image file (PNG, JPG) up to 5MB.'];
        }
    }
};
                    ...
                    <div class="px-6 py-4">
                        ...
                        <form @submit="handleSubmit">
                            ...
                            >
                                ...
                                <input id="file-upload" name="file-upload" type="file" @change="uploadAvatarPreview" class="sr-only" accept="image/*">
